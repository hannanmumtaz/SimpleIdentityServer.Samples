...
namespace OpenIdMigration.SqlServer.Migrations.SimpleIdServer
{
    public partial class SimpleIdServerMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TwoFactorAuthentication = table.Column<string>(nullable: true),
                    UpdateDateTime = table.Column<DateTime>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_profiles_resourceOwners_ResourceOwnerId",
                        column: x => x.ResourceOwnerId,
                        principalTable: "resourceOwners",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_profiles_ResourceOwnerId",
                table: "profiles",
                column: "ResourceOwnerId");
