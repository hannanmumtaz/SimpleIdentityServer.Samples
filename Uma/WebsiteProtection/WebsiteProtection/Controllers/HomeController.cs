...
using WebsiteProtection.ViewModels;

namespace WebsiteProtection.Controllers
{
    public class HomeController : Controller
    {
        ...
        public async Task<ActionResult> Logout()
        {
            ...
            HttpContext.Response.Cookies.Delete(SimpleIdentityServer.ResourceManager.Resolver.Constants.DefaultCookieName);
            HttpContext.Response.Cookies.Delete(SimpleIdentityServer.Uma.Authentication.Constants.DEFAULT_COOKIE_NAME);
