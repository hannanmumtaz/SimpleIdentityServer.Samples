        ...
        private static void InsertClients(SimpleIdentityServerContext context)
        {
            if (!context.Clients.Any())
            {
                context.Clients.AddRange(new[]
                {
                    ...
                    new SimpleIdentityServer.EF.Models.Client // Prescription website
                    {
                    ...
                    new SimpleIdentityServer.EF.Models.Client // Prescription api
                    {
                        ClientId = "MedicalPrescriptionApi",
                        ClientSecrets = new List<ClientSecret>
                        {
                            new ClientSecret
                            {
                                Id = Guid.NewGuid().ToString(),
                                Type = SecretTypes.SharedSecret,
                                Value = "qYZfCXJ39fnfByms"
                            }
                        },
                        ClientName = "Prescription api",
                        TokenEndPointAuthMethod = TokenEndPointAuthenticationMethods.client_secret_post,
                        LogoUri = "http://img.over-blog-kiwi.com/1/47/73/14/20150513/ob_06dc4f_chiot-shiba-inu-a-vendre-prix-2015.jpg",
                        PolicyUri = "http://openid.net",
                        TosUri = "http://openid.net",
