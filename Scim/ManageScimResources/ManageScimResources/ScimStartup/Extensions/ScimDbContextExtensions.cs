...
namespace ManageScimResources.ScimStartup.Extensions
{
    public static class ScimDbContextExtensions
    {
        ...
        {
             SchemaAttributeFactory.CreateAttribute(Constants.AttributeNames.Latitude, "Latitude", type: SimpleIdentityServer.Scim.Common.Constants.SchemaAttributeTypes.Decimal),
             SchemaAttributeFactory.CreateAttribute(Constants.AttributeNames.Longitutde, "Longitutde", type: SimpleIdentityServer.Scim.Common.Constants.SchemaAttributeTypes.Decimal),
        };
            ...
            Attributes = new List<SchemaAttribute>
            {
                ...
                SchemaAttributeFactory.CreateAttributeWithId(
                    _birthDateId,
                     ...
                     "BirthDate",
                     type: SimpleIdentityServer.Scim.Common.Constants.SchemaAttributeTypes.DateTime),
                // Location
